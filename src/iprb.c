...
sds iprb_rosalind_interface(FILE* stream) {
	...
	debug("raw result: %lf", _result);

	result = sdscatprintf(result, "%lf", _result);
	debug("sds result: %s", result);
	return result;
error:
	if (line != NULL)
		free(line);
...
double calculate_mendelian_inheritance(double homozygous_dominant, double heterozygous, double homozygous_recessive) {
	...
	debug("homozygous_dominant : %lf", homozygous_dominant);
	debug("heterozygous        : %lf", heterozygous);
	debug("homozygous_recessive: %lf", homozygous_recessive);

	double total_organisms = homozygous_dominant + homozygous_recessive + heterozygous;
	debug("total_organisms: %lf", total_organisms);

	double choose_homozygous_dominant = (
			(homozygous_dominant / total_organisms)
	);
	debug("choose_homozygous_dominant: %lf", choose_homozygous_dominant);
	...
	debug("choose_homozygous_recessive_choose_homozygous_dominant: %lf", choose_homozygous_recessive_choose_homozygous_dominant);  
	...
	debug("choose_homozygous_recessive_choose_heterzygous: %lf", choose_homozygous_recessive_choose_heterzygous);  
	...
	debug("choose_heterozygous_choose_homozygous_dominant: %lf", choose_heterozygous_choose_homozygous_dominant);
	...
	debug("choose_heterozygous_choose_homozygous_recessive: %lf", choose_heterozygous_choose_homozygous_recessive);
	...
	debug("choose_heterozygous_choose_heterozygous: %lf", choose_heterozygous_choose_heterozygous);
